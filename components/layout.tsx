...
export default function Layout({
  ...
  return (
    <div>
      ...
      <div className="fixed top-0 flex min-h-[52px] w-full max-w-xl items-center bg-white px-10 py-3 text-lg font-medium text-gray-800">
      ...
      {hasNavBar && (
        <nav className="fixed bottom-0 flex w-full max-w-xl items-center justify-evenly border-t bg-white px-10 py-5 text-gray-800">
          <Link
            href="/"
            className="flex h-12 w-12 flex-col items-center space-y-2"
          >
            {router.pathname === "/" ? (
              <svg
                fill="#22c55e"
